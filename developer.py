...
class Developer:
    def __init__(self,root):
        ...
        support=Label(Manage_std_frame1,bg="black",fg="blue",text="SHAHZAD ABBAS",font=("times new roman",22,"bold"))
        support.place(x=10,y=45)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="I am Student of Data Science learning computer vision and",font=("arial",12,"bold"))
        support.place(x=10,y=90)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="deep learning for programming langueges Python and R",font=("arial",12,"bold"))
        support.place(x=10,y=110)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="For more detail contact at...",font=("arial",12,"bold"))
        support.place(x=10,y=140)

        support = Label(Manage_std_frame1, bg="blue", fg="white", text="shahzadabbas3811@gmail.com",
                        font=("arial", 12, "bold"))
        support.place(x=10, y=160)
