...
class Student:
    def __init__(self,root):
        ...
        com_dep['value']=("Select Department","Computer","Math","Physics","Statistics","Information Technology","Chemistry","English")
        com_dep.current(0)
        ...
        com_txtcourse_std=ttk.Combobox(std_Info_label_frame,textvariable=self.var_course,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        com_txtcourse_std['value']=("Select Course","BS 4-Year","BSC 2-Year","MPhil","PHD")
        ...
        com_txt_currunt_year=ttk.Combobox(std_Info_label_frame,textvariable=self.var_year,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        com_txt_currunt_year['value']=("Select Year","2022-2026","2023-2027","2024-2028","2025-2029")
    ...
    def add_data(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_roll.get()=="" or self.usertype.get()==""):
            ...
            try:
                conn=mysql.connector.connect(auth_plugin='mysql_native_password', host="localhost",user="root",password="ch381144",database="facial_recognition")
